        ...
        <section className="institution-requests">
          ...
          {institution.id === "sahya" ? (
            <div className="request-history">
              ...
              <article className={committeeDecision === "approved" ? "complete" : "current"}><span>{committeeDecision === "approved" ? <Check size={12} /> : <Clock3 size={12} />}</span><div><strong>Committee decision</strong><small>{committeeDecision === "approved" ? "Exception approved" : "Decision pending"}</small></div></article>
